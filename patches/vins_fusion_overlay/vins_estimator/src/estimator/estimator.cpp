...
void Estimator::configureRecoveryBridge(bool enable, int max_recoveries, double time_tolerance,
...
void Estimator::configureRecoveryGeometry(double max_flow_error, int min_flow_tracks)
{
    featureTracker.configureRecoveryGeometry(max_flow_error, min_flow_tracks);
}
...
void Estimator::inputRecoveryCandidates(double t, const vector<RecoveryCandidate> &candidates)
{
    featureTracker.setRecoveryCandidates(t, candidates);
}
